...
const TestimonialsSection = () => {
  ...
  return (
    <section id="depoimentos" className="py-20 bg-primary overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        >
          {duplicatedTestimonials.map((testimonial, index) => (
            <Card key={`row1-${index}`} className="construction-card min-w-[350px] bg-card border-border">
        ...
        >
          {duplicatedTestimonials.map((testimonial, index) => (
            <Card key={`row2-${index}`} className="construction-card min-w-[350px] bg-card border-border">
              <div className="flex items-center space-x-4 mb-4">
                <img 
                  src={testimonial.image} 
                  alt={testimonial.name}
